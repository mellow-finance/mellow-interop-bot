...
def collect(source_core_address: str, target_core_address: str) -> None:
    ...
    print('Actions ({}):'.format(source_core_address))
    if source_amounts[1] > 0:
        print('SourceCore({})::pushToTarget({});'.format(
            source_core_address, source_amounts[1]))
    ...
    if target_amounts[0] > 0:
        print('TargetCore({})::pushToSource({});'.format(
            target_core_address, target_amounts[0]))
